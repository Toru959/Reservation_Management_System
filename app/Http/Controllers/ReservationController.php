...
class ReservationController extends Controller
{
    ...
    public function detail($id){
        ...
        return view('event-ditail', compact('event', 'reservablePeople', 'isReserved'));
    }

    public function reserve(Request $request)
    {
        // dd($request->reserved_people);
            ...
            $event->max_people >= $reservedPeople->number_of_people + $request->reserved_people)
        {
            ...
            session()->flash('status', 'This number of people cannot be reserved.');
            return to_route('dashboard');
        }
    }
}
